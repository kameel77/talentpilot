...
export const GALLUP_TALENTS: GallupTalent[] = [
    // Executing
        ...
        { code: 'consistency', en: 'Consistency', pl: 'Bezstronność', en_desc: 'Treats everyone equally', pl_desc: 'Traktuje wszystkich równo', domain: 'executing' },
    ...
    // Influencing
        ...
        { code: 'self-assurance', en: 'Self-Assurance', pl: 'Wiara w siebie', en_desc: 'Confidence in abilities', pl_desc: 'Pewność swoich umiejętności', domain: 'influencing' },
    ...
    // Relationship Building
        ...
        { code: 'developer', en: 'Developer', pl: 'Rozwijanie innych', en_desc: 'Sees potential in others', pl_desc: 'Dostrzega potencjał w innych', domain: 'relationship_building' },
