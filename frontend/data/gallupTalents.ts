...
export const GALLUP_TALENTS: GallupTalent[] = [
    ...
    { id: 'belief', name: 'Belief', namePl: 'Pryncypialność', domain: 'executing', description: 'Core values are unchanging', descriptionPl: 'Podstawowe wartości są niezmienne' },
    ...
    { id: 'significance', name: 'Significance', namePl: 'Poważanie', domain: 'influencing', description: 'Wants to be important', descriptionPl: 'Chce być znaczący' },
    ...
    { id: 'connectedness', name: 'Connectedness', namePl: 'Współzależność', domain: 'relationship', description: 'Believes in links between things', descriptionPl: 'Wierzy w powiązania między rzeczami' },
    ...
    { id: 'includer', name: 'Includer', namePl: 'Integrator', domain: 'relationship', description: 'Includes everyone', descriptionPl: 'Włącza wszystkich' },
    ...
    { id: 'positivity', name: 'Positivity', namePl: 'Optymista', domain: 'relationship', description: 'Enthusiastic and energizing', descriptionPl: 'Entuzjastyczny i energetyzujący' },
    { id: 'relator', name: 'Relator', namePl: 'Bliskość', domain: 'relationship', description: 'Deep relationships', descriptionPl: 'Głębokie relacje' },
    ...
    { id: 'ideation', name: 'Ideation', namePl: 'Odkrywczość', domain: 'strategic', description: 'Fascinated by ideas', descriptionPl: 'Zafascynowany pomysłami' },
